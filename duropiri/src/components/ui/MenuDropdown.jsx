...
const MenuDropdown = ({ onClose, isOpen }) => {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <div className="flex w-full h-full md:py-6 justify-end items-center">
        <ul className="flex flex-col h-full items-end navigation-text justify-between">
          <li
            className="font-semibold text-light-primary dark:text-dark-primary flex h-auto leading-snug"
            onClick={() => {
              document
                .getElementById("home")
      ...
      <div className="flex flex-row w-full h-[32px] justify-between mt-6">
        <label className="swap swap-rotate followerchangetest w-1/2 justify-start">
          ...
          {/* sun icon */}
          <svg
            className="swap-on fill-current w-8 h-8 text-light-accent dark:text-dark-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
          ...
          {/* moon icon */}
          <svg
            className="swap-off fill-current w-8 h-8 text-light-accent dark:text-dark-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          >
        ...
        <ul className="flex flex-row h-full items-start gap-6 w-1/2 justify-end">
          {/* LinkedIn */}
          <li>
            <a
