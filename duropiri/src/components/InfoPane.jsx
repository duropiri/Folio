  ...
  return (
    <>
      {all && (
        <>
          {!dropdown ? (
            <div className="info-panel flex w-[860px] h-full text-[16px] text-right text-light-primary dark:text-dark-primary">
              <div className="flex w-full justify-between">
                ...
                <ul className="w-1/4 leading-[26px]">
                  ...
                  <li>
                    <span class="blinker w-2 h-2 bg-[#4cd137] inline-block rounded-full mr-3"></span>
                    <span>Available</span>
                  </li>
                </ul>
                <ul className="flex flex-col w-1/4 justify-between leading-[26px]">
                  <li className="flex flex-row justify-end h-5 items-end">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="w-4 h-4 text-light-primary dark:text-dark-primary ml-[10px]"
                    >
                      <path
                  ...
                  <li>
                    <span>duro.dp02@gmail.com</span>
                  </li>
                </ul>
              </div>
            </div>
          ) : (
            <div className="info-panel flex w-full h-full text-[16px] text-right text-light-primary dark:text-dark-primary">
              <div className="flex w-full justify-between">
                <ul className="flex flex-col justify-center leading-[24px]">
                  <li>
                    <span>Based in</span>
                  </li>
