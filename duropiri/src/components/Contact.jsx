      ...
      <div className="relative w-full py-[25px] xl:py-[50px]">
        <div className="flex flex-col justify-start gap-[50px] xl:gap-[100px] z-10">
          <div className="flex flex-col gap-[8px]">
            <div>
              <span className="uppercase font-khand text-[112px] font-semibold text-light-primary dark:text-dark-primary leading-snug">
                Get In Touch.
              </span>
            </div>
            <div className="flex flex-col xl:flex-row w-full gap-[20px]">
              <div className="flex flex-col w-full xl:w-1/2 gap-[30px]">
                <p className="text-[32px] font-medium flex relative leading-snug text-light-primary dark:text-dark-primary w-full">
                ...
                <div className="flex flex-row w-full gap-[30px]">
                  ...
                  <div className="flex flex-col gap-[10px] w-1/2">
                    <span className="uppercase font-khand text-[32px] font-semibold text-light-primary dark:text-dark-primary">
                      Navigation.
                    </span>
