          ...
          <div className="flex flex-col justify-start gap-[50px] xl:gap-[100px] z-10">
            <div className="flex flex-col gap-[8px]">
              ...
              <div className="flex flex-col xl:flex-row w-full gap-[20px]">
                ...
                <form className="flex flex-col w-full min-h-[489px] h-auto xl:w-1/2 gap-[30px]">
                  <div className="flex flex-row w-full h-[48px] gap-[20px]">
                    <input
                      type="text"
                      name="name"
                      placeholder="Your name"
                      className="w-1/2 text-[16px] p-[10px] text-light-primary dark:text-dark-primary border-r-[1px] border-b-[1px] border-light-primary dark:border-dark-primary outline-none"
                    />
                    <input
                      type="email"
                      name="email"
                  ...
                  <textarea
                    ...
                    className="w-full h-full text-[16px] p-[10px] text-light-primary dark:text-dark-primary border-r-[1px] border-b-[1px] border-light-primary dark:border-dark-primary outline-none"
                  />
                  <button
                    type="submit"
