  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[10px]">
        ...
        <ul className="flex flex-row text-[18px] font-medium text-light-primary dark:text-dark-primary w-full gap-[10px]">
          <li className="bg-light-background dark:bg-dark-background py-[10px] px-[25px]">
            Python
          </li>
          <li className="bg-light-background dark:bg-dark-background py-[10px] px-[25px]">
            Java
