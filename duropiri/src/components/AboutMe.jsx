...
const AboutMe = () => {
  return (
    <div className="relative w-full h-full">
      ...
      <Parallax >
        <div className="overflow-hidden z-0 max-w-sm 2xl:max-w-lg 3xl:max-w-xl relative mt-[-lvh*0.1] mx-auto pointer-events-none">
          <div data-speed="2" className="w-[533px] h-[650px] bg-light-background dark:bg-dark-accent"></div>
        </div>
      </Parallax>
